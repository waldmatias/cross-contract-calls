import { VM, VMContext, u128 } from "near-sdk-as";
...
describe('20.nearly-neighbors.proposal', () => {
  describe('initialize(): void', () => {
    ...
    it('is idempotent; will throw if already initialized', () => {
      VMContext.setAttached_deposit(u128.mul(ONE_NEAR, u128.from(3)))
      contract.initialize()
  ...
  describe('configure(title, description, goal, min_deposit): void', () => {
    ...
    it('requires that the contract be initialized', () => {
